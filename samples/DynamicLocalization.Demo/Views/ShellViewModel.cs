...
using DynamicLocalization.Demo.Extensions;
using DynamicLocalizationUI.Avalonia.Interfaces;
using DynamicLocalizationUI.Avalonia.Models;
using Prism.Commands;
using Prism.Mvvm;

namespace DynamicLocalization.Demo.Views;
